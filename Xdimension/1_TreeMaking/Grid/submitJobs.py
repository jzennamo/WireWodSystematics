...
outtar.add("Tracks_TreeMakerMC.C",arcname="Tracks_TreeMakerMC.C")
...
setup uboonecode v08_00_00_19 -q e17:prof  >>${_RUN_NUMBER}.out 2>&1
...
root -l -b -q Tracks_TreeMakerMC.C  >>${_RUN_NUMBER}.out 2>&1
